...
public class NewBook extends javax.swing.JFrame {
   ...
   public NewBook(Book book, String usuario1) { // Modificando o construtor
        initComponents();
        
        this.book = book;
        this.usuario = usuario; // Inicializando o nome do usuário
        if (this.book != null) {
 ...
 private void inserir() {
        ...
        bookNew.setUsuario(usuario); // Definindo o usuário que adiciona o livro
...
private void editar() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewBook(null, usuario).setVisible(true);
            }
        });
    }
