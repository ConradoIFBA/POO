...
public LibraryMain(String usuarioAtual) {
    this.usuarioAtual = usuarioAtual;  // Armazena o usuário logado
    initComponents();
 ...
 private void preencherTabela() {
    ...
    try {
        for (Book book : bookDAO.listar()) {
            modelo.addRow(new Object[]{
                ...
                book.getGenre(),
                book.getEditora(),
                book.getUsuario()  // Exibe o nome do usuário na coluna "Usuário"
            });
        }
    } catch (Exception e) {
        e.printStackTrace();
    ...
    private void initComponents() {
        ...
        TableBook.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Titulo", "Autor", "Ano", "Genero", "Editora", "Usuario"
            }
        ) {
    ...
    private void jBtnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnNovoActionPerformed
       NewBook nb = new NewBook(null, usuario); // Passa o usuário atual
    nb.setVisible(true);
...
private void editar() { 
    try {
        ...
        if (selectedRow >= 0) {
            ...
            Integer ano = (Integer) modelo.getValueAt(selectedRow, 3);
            String genero = (String) modelo.getValueAt(selectedRow, 4);
            String editora = (String) modelo.getValueAt(selectedRow, 5);
            String usuario = (String) modelo.getValueAt(selectedRow, 6); // Usuário que cadastrou o livro
            Integer codigo = (Integer) modelo.getValueAt(selectedRow, 0);
            ...
            book.setUsuario(usuario); // Mantém o usuário que cadastrou o livro

            // Passando o nome do usuário como segundo parâmetro
            new NewBook(book, usuario).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, selecione uma linha.");
        }
    } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        String usuarioAtual = "Nome do Usuario"; // Aqui você deve pegar o usuário logado de alguma forma
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            new LibraryMain(usuarioAtual).setVisible(true);
        }
        });
    }
